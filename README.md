...
get data: we have to set a token 
buld ypour state do your login form, do your login flow and set up hanfle changes also do an api request and get info from api with axuos