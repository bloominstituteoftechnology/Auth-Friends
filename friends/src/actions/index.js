...
export const FETCHING_CHARS = 'FETCHING_FRIENDS';
export const FETCHING_CHARS_SUCCESS = 'FETCHING_FRIENDS_SUCCESS';
export const FETCHING_CHARS_FAILURE = 'FETCHING_FRIENDS_FAILURE';
